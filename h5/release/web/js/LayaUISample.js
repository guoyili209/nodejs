...
var TestUI = /** @class */ (function (_super) {
    ...
    TestUI.prototype._websocketTest = function () {
        ...
        this._byte.writeInt16(201);
        this._byte.pos = 0;
        this._byte.writeInt32(this._byte.length + 4);
    };
    TestUI.prototype._openHandler = function (e) {
        if (e === void 0) { e = null; }
        console.log("连接");
    };
    TestUI.prototype._receiveHandler = function (msg) {
        if (msg === void 0) { msg = null; }
    };
    TestUI.prototype._closeHandler = function (e) {
        if (e === void 0) { e = null; }
        console.log("关闭");
    };
    TestUI.prototype._errorHandler = function (e) {
        if (e === void 0) { e = null; }
        console.log("错误:" + e);
    };
